...
class ChecklistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checklist" do
    assert_difference('Checklist.count') do
      post checklists_url, params: { checklist: { lesson_id: @checklist.lesson_id, site_id: @checklist.site_id } }
    end
  ...
  test "should update checklist" do
    patch checklist_url(@checklist), params: { checklist: { lesson_id: @checklist.lesson_id, site_id: @checklist.site_id } }
