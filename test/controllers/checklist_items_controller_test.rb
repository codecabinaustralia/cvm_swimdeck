...
class ChecklistItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checklist_item" do
    assert_difference('ChecklistItem.count') do
      post checklist_items_url, params: { checklist_item: { checklist_id: @checklist_item.checklist_id, notes: @checklist_item.notes, title: @checklist_item.title } }
    end
  ...
  test "should update checklist_item" do
    patch checklist_item_url(@checklist_item), params: { checklist_item: { checklist_id: @checklist_item.checklist_id, notes: @checklist_item.notes, title: @checklist_item.title } }
